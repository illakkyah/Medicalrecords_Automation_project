...
public class PatientTest extends AutomationWrapper {
	...
	public void addValidPatientTest() {
		...
		frame1.locator("xpath=//button[@id='confirmCreate']").click();
		String actualDashboardHeader = frame.locator("xpath=//span[contains(text(),'Medical Record Dashboard')]")
				.innerText();
		Assert.assertTrue(actualDashboardHeader.contains("Medical Record Dashboard"));
	}
